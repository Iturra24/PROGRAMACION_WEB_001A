...
from .models import Usuario, TipoUsuario, Region
...
class Profile(TemplateView):
    ...
    def get(self, request):
        ...
        obj_usuario = Usuario.objects.get(email = usuario['email'])
    ...
    def post(self, request):
        ...
        try:
            ...
            print(request.POST)
            email = request.POST['email']
            region = Region.objects.get(id = int(request.POST['region']))
            tipo_usuario = TipoUsuario.objects.get(id = int(request.POST['tipo_usuario']))
...
class APIsInternas(TemplateView):
    ...
    def get(self, request):
        ...
        usuario = Usuario.objects.get(email = request.session['usuario']['email'])
    ...
    def post(self, request):
        ...
        try:
            if request.POST['tipo_form'] == 'categoria':
                new_categoria = Categoria(nombre = request.POST['nombre'])
                new_categoria.save()
